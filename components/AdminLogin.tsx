  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div>
          <div className="mx-auto h-12 w-12 flex items-center justify-center bg-red-600 rounded-xl">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="mt-1 appearance-none relative block w-full px-3 py-2 border border-slate-300 placeholder-slate-500 text-slate-900 rounded-lg focus:outline-none focus:ring-red-500 focus:border-red-500 focus:z-10"
                placeholder="admin"
              />
            </div>
          ...
          <div className="text-center">
            <p className="text-xs text-slate-500">
              Pro přístup do administrace kontaktujte správce webu
            </p>
          </div>
        </form>
      </div>
