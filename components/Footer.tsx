    ...
    <footer className="bg-gray-800 text-white py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Organization Info */}
          <div>
            <h3 className="font-bold text-xl mb-4">{siteData.title}</h3>
            <p className="text-gray-300 mb-4">Pionýr, z.s.</p>
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              <Link href="/ldt-bela" className="block text-gray-300 hover:text-white transition-colors">
                LDT Bělá
              </Link>
              <Link href="/blog" className="block text-gray-300 hover:text-white transition-colors">
                Články
              </Link>
              <Link href="/kalendar-akci" className="block text-gray-300 hover:text-white transition-colors">
                Kalendář akcí
              </Link>
